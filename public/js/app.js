...
(function (factory) {
  ...
  Markdown.prototype = {
    ...
    __setEventListeners: function __setEventListeners() {
      this.$textarea.on({
        ...
        this.$editor.on('drop', function (e) {
          ...
          $.each(e.originalEvent.dataTransfer.files, function (index, file) {
            ...
            fileReader.onload = function (file) {
              ...
              return function (e) {
                var text = textarea.val();
                if (type === 'image') textarea.val(text.substring(0, caretPos) + '\n<img src="' + e.target.result + '" />\n' + text.substring(caretPos));else textarea.val(text.substring(0, caretPos) + '\n<a href="' + e.target.result + '">Download ' + file.name + '</a>\n' + text.substring(caretPos));
              };
            }(file);
    ...
    insertContent: function insertContent(index, content) {
    ...
    getBulletNumber: function getBulletNumber(startIndex) {
  ...
  $.fn.markdown.defaults = {
    ...
    onPreviewEnd: function onPreviewEnd(e) {},
    onSave: function onSave(e) {},
    onBlur: function onBlur(e) {},
    onFocus: function onFocus(e) {},
    onChange: function onChange(e) {},
    onFullscreen: function onFullscreen(e) {},
    onFullscreenExit: function onFullscreenExit(e) {},
