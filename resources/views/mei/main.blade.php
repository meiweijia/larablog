...
<head>
	...
	<meta name="keywords" content="梅渭甲,梅渭甲的个人博客">
...
<div class="container">
	...
	<footer class="footer" style="text-align: center;    border-top: 2px solid #eee;">
			...
			基于 <a style="color:rgb(251, 128, 105)" href='http://lumen.laravel.com' title="为速度而生的 Laravel 框架" target="_blank">lumen</a> |
				...
				<a target="_blank" href="http://www.qiniu.com/" title="七牛"><img style="width:37px;height:27px" src="/img/qiniu-55x41.png" alt="七牛"></a>提供云存储
			</p>
	</footer>
</div>
