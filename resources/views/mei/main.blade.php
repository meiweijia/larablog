...
<head>
    ...
    <meta name="keywords"
          content="梅氏起源,家族,梅世科,梅文贵,梅丽娥,梅文献,梅渭甲,梅浩,梅氏族谱,七甲坪,lumen,laravel,pjax,ajax,javascript,asp.net,PHP">
...
<div class="container">
    <a href="/" class="/" style="float: left;margin: 20px 10px 10px 10px;">
        <img src="http://static.meibk.com/img/logo.png"/>
    </a>
    ...
    <footer class="footer" style="text-align: center;    border-top: 2px solid #eee;">
        ...
        <p>
            ...
            <a target="_blank" href="/sitemap.xml">网站地图</a> | <a target="_blank" href="http://www.qiniu.com/"><img
                        src="/img/qiniu-55x41.png"></a>
        </p>
    </footer>
</div>
