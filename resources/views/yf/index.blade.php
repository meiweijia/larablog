...
@section('post')
	...
	foreach($posts as $post)
	{
		...
		<a target='_blank' class='focus' href='/post/{$post->id}.html'><img data-src='{$img_url}' class='thumb'/></a>
		<header><a target='_blank' class='cat' href='/fenlei'>分类<i></i></a> <h2><a target='_blank' href='/post/{$post->id}.html' title='{$post->post_title}'>{$post->post_title}</a></h2></header>
		<p class='meta'><time><i class='fa fa-clock-o'></i>{$post_date}</time><span class='pv'><i class='fa fa-eye'></i>阅读(5154)</span><a target='_blank' class='pc' href='/post/{$post->id}.html#comments'><i class='fa fa-comments-o'></i>评论(2)</a></p>
