...
@section('content')
    <div class="d-block card mb-4">
        <div class="card-body shadow-lg">
            ...
            <ul>
                <li>现主玩PHP，熟悉并熟练使用laravel框架，理解laravel框架的核心技术，包括但不限于IOC，Facade，服务容器、服务提供者，并在项目中有实际使用经验。
                </li>
                <li>熟悉C#，熟悉EF框架。</li>
            ...
            <blockquote class="blockquote">
                ...
                <p class="mb-0">一个人的价值，在于他贡献了什么，而不在于他能得到什么。</p>
                <footer class="blockquote-footer text-right"><cite title="Source Title">阿尔伯特·爱因斯坦</cite></footer>
            </blockquote>
            <h3>编程之路</h3>
            <ul>
                <li>小学的时候通CS接触计算机。</li>
